...
// Final JSON error handler so API failures (including uploads/CORS) never
// return an unexpected HTML page to either frontend.
app.use((error, req, res, next) => {
  ...
  if (error?.code === "LIMIT_FILE_SIZE") message = "The uploaded file is too large.";
